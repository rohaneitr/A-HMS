                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-lg-3 text-center mb-4">
                                                                ...
                                                                <h5 class="font-weight-bold mb-0"><?php echo $patient->name; ?></h5>
                                                                <small class="text-muted">ID: <?php echo $patient->id; ?></small>
                                                            </div>

                                                            <div class="col-lg-4">
                                                                <div class="info-group mb-4">
                                                                    <h6 class="text-primary mb-3 font-weight-bold"><?php echo lang('personal_information'); ?></h6>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('email_address'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->email; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('government_id_number'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->national_id; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('age'); ?></label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('gender'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->sex; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('contact_number'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->phone; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('residential_address'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->address; ?></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-5">
                                                                <div class="info-group mb-4">
                                                                    <h6 class="text-primary mb-3 font-weight-bold"><?php echo lang('medical_information'); ?></h6>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('blood_group'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->bloodgroup; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('doctor'); ?></label>
                                                                        <div class="font-weight-medium"><?php
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('height'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->height; ?></div>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('weight'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->weight; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('known_allergies'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->known_allergies; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('medical_history'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->medical_history; ?></div>
                                                                    </div>
                                                                </div>

                                                                <div class="info-group">
                                                                    <h6 class="text-primary mb-3 font-weight-bold"><?php echo lang('emergency_contact'); ?></h6>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('emergency_contact_name'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->emergency_contact_name; ?></div>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label class="text-muted mb-1"><?php echo lang('emergency_contact_number'); ?></label>
                                                                        <div class="font-weight-medium"><?php echo $patient->emergency_contact_number; ?></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        .clickUl li {
            flex: 1 1 100%;
                                              ...
                                              c-0.6,1.5-0.3,3.6,1.1,4.2c2.7,1.1,4.3,4.2,3.8,7.1c-1,1-2.2-0.9-2.6-2.2C54.3,272.8,50.8,270.2,47.9,271.6z" />
                                                                ...
                                                                <div style=" float:left; width:50%; margin-top:80px; ">
                                                                    ...
                                                                    <textarea
                                                                        ...
                                                                        name="description"
                                                                        <?php if (empty($odontogram->description)) { ?>
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($vital_signs as $vital_sign) { ?>
                                                                    <tr class="">
                                                                        ...
                                                                        <td><?php echo $vital_sign->heart_rate; ?> bpm</td>
                                                                        <td><?php echo $vital_sign->systolic_blood_pressure; ?>/<?php echo $vital_sign->diastolic_blood_pressure; ?>
                                                                            mmHg</td>
                                                                        <td><?php echo $vital_sign->temperature; ?> &deg;C
                                                                        </td>
                                                                        <td><?php echo $vital_sign->oxygen_saturation; ?>%
                                                                        </td>
                                                                        <td><?php echo $vital_sign->respiratory_rate; ?> bpm
                                                                        </td>
                                                                        <td><?php echo $vital_sign->bmi_weight; ?> Kg</td>
                                                                        <td><?php echo $vital_sign->bmi_height; ?> Cm</td>
                                                                        <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                    ...
                    <!--</a>-->
                                ...
                                <?php }else{ ?>
                                    <div class="form-group d-flex">
                                    <label class="exampleInputEmail1 col-sm-4" ><?php echo lang('doctor'); ?> </label>
                                    <select class="form-control form-control-lg col-sm-8" id="doctorchoose" name="doctor_id" required="">
                                    <?php if (!empty($case->id)) { ?>
                                                                                        ...
                                                                                        <?php foreach ($doctors as $doctor) {
                                                                                            ?>
                                                                                            <option
                                                                                                value="<?php echo $doctor->id; ?>" <?php if ($doctor->id == $case->doctor_id) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } ?>>
                                    ...
                                    <?php } ?>
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php if (!empty($case->id)) { ?>
                                                                                        ...
                                                                                        <?php foreach ($symptoms as $symptom) {
                                                                                            ...
                                                                                            <option
                                                                                                value="<?php echo $symptom->id; ?>" <?php if (in_array($symptom->id, $symptom_ids)) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } ?>>
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php if (!empty($case->id)) { ?>
                                                                                        ...
                                                                                        <?php foreach ($tests as $test) {
                                                                                            ...
                                                                                            <option
                                                                                                value="<?php echo $test->id; ?>" <?php if (in_array($test->id, $test_ids)) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } ?>>
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php if (!empty($case->id)) { ?>
                                                                                        ...
                                                                                        <?php foreach ($diagnosiss as $diagnosis) {
                                                                                            ...
                                                                                            <option
                                                                                                value="<?php echo $diagnosis->id; ?>" <?php if (in_array($diagnosis->id, $diagnosis_ids)) {
                                                                                                                                            echo 'selected';
                                                                                                                                        } ?>>
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php if (!empty($case->id)) { ?>
                                                                                        ...
                                                                                        <?php foreach ($treatments as $treatment) {
                                                                                            ...
                                                                                            <option
                                                                                                value="<?php echo $treatment->id; ?>" <?php if (in_array($treatment->id, $treatment_ids)) {
                                                                                                                                            echo 'selected';
                                                                                                                                        } ?>>
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php if (!empty($case->id)) { ?>
                                                                                        ...
                                                                                        <?php foreach ($advices as $advice) {
                                                                                            ...
                                                                                            <option
                                                                                                value="<?php echo $advice->id; ?>" <?php if (in_array($advice->id, $advice_ids)) {
                                                                                                                                        echo 'selected';
                                                                                                                                    } ?>>
                                            ...
                                            <div id="profile" class="tab-pane <?php if ($redirect_tab == 'files') {
                                                ...
                                                <div class="">
                                                    ...
                                                    <?php } ?>
                                                    <div class="adv-table editable-table " >
                                                        <table class="table table-bordered table-hover text-md" id="files_table">
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr class="">
                                                                            ...
                                                                            <td><?php echo date('d-m-Y', $patient_material->date); ?></td>
                                                                            <td>
                                                                            ...
                                                                            <td class="no-print">
                                                                            <a class="btn btn-info btn-sm" href="<?php echo $patient_material->url; ?>" download> <?php echo lang('download'); ?> </a>
                                                                            <a class="btn btn-danger btn-sm delete_button" href="patient/deletePatientMaterial?id=<?php echo $patient_material->id; ?>" onclick="return confirm(\'You want to delete the item?\');"> X </a>
                                                                            </td>
                                                                        </tr>
                                                                <?php }
                                                                ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title no-print"> <?php echo lang('case'); ?> <?php echo lang('details'); ?></h4>
            ...
            <div class="card-body">
                    <table class="table table-bordered">
                            <tr>
                                <td><label for="exampleInputEmail1"><?php echo lang('case'); ?> <?php echo lang('creation'); ?> <?php echo lang('date'); ?></label></td>
...
<br>
                    ...
                    <div class="col-md-3 no-print">
                        <a class="btn btn-info invoice_button float-right" id="printButtonn"><i class="fa fa-print"></i> <?php echo lang('print'); ?> </a>
                    </div>
                    </div>
...
<div class="modal fade" id="myModalf" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('add'); ?> <?php echo lang('folder'); ?></h4>
...
<div class="modal fade" id="myModalfe" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('edit'); ?> <?php echo lang('folder'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="myModalVital" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('add'); ?> <?php echo lang('vital_sign'); ?>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="myModalVitalEdit" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('edit'); ?> <?php echo lang('vital_sign'); ?>
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('add_case'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="myModal22" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title font-weight-bold"> <?php echo lang('edit_case'); ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                    ...
                    <?php if (!$this->ion_auth->in_group(array('Nurse', 'Doctor'))) { ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group cardsubmit d-none">
                                <button type="submit" name="pay_now" id="submit-btn" class="btn btn-primary btn-block"
                                    <?php if ($settings->payment_gateway == 'Stripe') { ?>onClick="stripePay(event);"
                                    <?php } ?>
                                    <?php if ($settings->payment_gateway == '2Checkout' && $twocheckout->status == 'live') { ?>onClick="twoCheckoutPay(event);"
                                    <?php } ?>>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group cardsubmit1 d-none">
                                <button type="submit" name="pay_now" id="submit-btn1"
                                    ...
                                    <?php if ($settings->payment_gateway == 'Stripe') { ?>onClick="stripePay1(event);"
                                    <?php } ?>
                                    <?php if ($settings->payment_gateway == '2Checkout' && $twocheckout->status == 'live') { ?>onClick="twoCheckoutPay1(event);"
                                    <?php } ?>>
                                    <?php echo lang('submit'); ?>
                                </button>
                            </div>
            ...
            <div class="modal-body p-4">
                <form role="form" id="editPatientForm" action="patient/addNew" method="post"
                    ...
                    <input type="hidden" name="p_id"
                        value='<?php if (!empty($patient->patient_id)) echo $patient->patient_id; ?>'>
