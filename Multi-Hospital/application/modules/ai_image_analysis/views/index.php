            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">AI Image Analysis</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="tab-pane fade show active" id="upload" role="tabpanel" aria-labelledby="upload-tab">
                                    ...
                                    <form id="imageUploadForm" enctype="multipart/form-data">
                                        ...
                                        <div id="imageSelector" class="text-center border border-dashed rounded p-4 mb-3" style="border-color: #dee2e6;">
                                            ...
                                            <h5 class="text-muted">Select Medical Image</h5>
                                            <p class="text-muted">AI will automatically detect image type</p>
                                            ...
                                            <button type="button" class="btn btn-outline-primary" onclick="document.getElementById('imageFile').click()">
                                                <i class="fas fa-plus mr-2"></i>Choose Image
                                            </button>
