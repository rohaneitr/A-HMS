...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>AI Patient Overview</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="home">Home</a></li>
                        <li class="breadcrumb-item active">AI Patient Overview</li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="text-center">
                                                <button type="button" class="btn btn-primary btn-lg" id="generateBtn" onclick="generateOverview()">
                                                    <i class="fas fa-brain mr-2"></i>Generate AI Patient Overview
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td colspan="5" class="text-center text-muted">
                                                                        <i class="fas fa-spinner fa-spin mr-2"></i>Loading analysis history...
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted">Please wait while our AI analyzes the patient data and generates a comprehensive overview.</p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            <h5 class="mb-0"><i class="fas fa-brain mr-2"></i>AI Analysis Overview</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Vital Signs</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Case History</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Hospitalizations</p>
                        </div>
                    </div>
                </div>
            </div>
